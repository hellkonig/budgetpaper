...
\author[Wang et al.]{Liang Wang$^{1,3,4}$\thanks{wangliang@pmo.ac.cn}, Aaron A. Dutton$^{2,3}$,
...
$^4$International Centre for Radio Astronomy Research (ICRAR)
, M468, University of Western Australia, 35 Stirling Hwy, Cr
awley, WA 6009, Australia}
\begin{document}
...
\citep[e.g.,][]{Crain10, Christensen16,Voort16}} found the baryon fraction
...
parameters from the Planck  satellite \citep{Planck14}.   {\bf Dark
...
fractions of total stellar mass {\bf within 20\% $R_{200}$} (blue
...
\begin{figure*}
\centerline{
  \psfig{figure=budget_res.eps,width=0.95\textwidth}
}
\caption{{\bf Baryon content of NIHAO simulations as a function of
...
shallower potential wells of lower mass halos according {\bf to} the
mass loading factor and circular velocity  {\bf relation }$\eta
...
gas and stars that belong to nearby lower mass haloes.  {\bf It is a
  radius within the high-resolution volume of the simulations since
  the contamination fraction in a shell between 0.9 and  1.0 $\Rbar$
...
virial and baryon radius (open red points).  {\bf All fractions are
...
disk gas mass comes from \citet{Dutton11}.  {\bf The upper limits to
...
{\bf Since \citet{Crain10} and \citet{Voort13} show that  soft X-ray
...
% NIHAO VIII:
\bibitem[Gutcke et al.(2016)]{Gutcke16} Gutcke, T.~A., Stinson, G.~S., Macci{\`o}, A.~V., et al.\ 2016, arXiv:1602.06956, MNRAS in press
...
\bibitem[Oppenheimer et al.(2016)]{Oppenheimer16} Oppenheimer, B.~D., Crain, R.~A., Schaye, J., et al.\ 2016, \mnras, 460, 2157 
...
\bibitem[Suresh et al.(2015)]{Suresh15} Suresh, J., Rubin, K.~H.~R., Kannan, R., et al.\ 2015, arXiv:1511.00687
...
\bibitem[van de Voort et al.(2016)]{Voort16} van de Voort, F., Quataert, E., Hopkins, P.~F., et al.\ 2016, \mnras, 463, 4533 
