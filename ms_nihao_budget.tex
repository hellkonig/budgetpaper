...
\begin{abstract}
  ...
  30\%$ missing, consistent with {\bf recent} observational estimates.
\end{abstract}
...
to a wider range of halo masses.  {\bf A number of large volume
...
project.
{\bf Reproducing the stellar mass content in dark matter haloes both
...
{\bf In Fig.~\ref{fig:inout}, we show the fractions of gas (in each
